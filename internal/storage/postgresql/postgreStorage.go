...
func NewPostgresStorage(config config.Config) (*PostgreDBStorage, error) {
...
func (s *PostgreDBStorage) CheckConnection() error {
...
func (s *PostgreDBStorage) Close() error {
	return s.conn.Close()
}

func (s *PostgreDBStorage) SaveWallet(ctx context.Context, id string, balance float64) error {
...
func (s *PostgreDBStorage) TakeWallet(ctx context.Context, id string) (string, float64, error) {
...
func (s *PostgreDBStorage) UpdateWallet(ctx context.Context, id string, balance float64) error {
...
func (s *PostgreDBStorage) SaveInfo(ctx context.Context, from string, to string, amount float64, time string) error {
...
func (s *PostgreDBStorage) GetInfo(ctx context.Context, id string) ([]shema.HistoryTransfers, error) {
